...
# bot
bot_token = os.environ.get("TOKEN", "6067557672:AAEMXTxLuot6b5RxH4OZMrVS0PEAV4oLgVg")
api_hash = os.environ.get("HASH", "770f97c9e788a9ff74740275413488e7") 
api_id = os.environ.get("ID", "23224249")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Source Code", url="https://github.c/bipinkrish/Link-Bypasser-Bot")]]), reply_to_message_id=message.id)
